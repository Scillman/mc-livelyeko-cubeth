...
public class CubethBlocks {
    ...
    public static final Block GLASS_PLATE = new GlassPlate(AbstractBlock.Settings.create().noBlockBreakParticles().strength(0.0f), 0);
    public static final Block GLASS_PLATE_OF_SLICED_CAKE = new GlassPlate(AbstractBlock.Settings.create().noBlockBreakParticles().strength(0.0f), 1);
    ...
    public static void initialize() {
        ...
        Registry.register(Registries.ITEM, Identifier.of(CubethMod.MOD_ID, "glass_cup"), new me.livelyeko.cubethmod.item.dinnerware.GlassCup(GLASS_CUP, new Item.Settings()));
        ...
        Registry.register(Registries.ITEM, Identifier.of(CubethMod.MOD_ID, "glass_plate"), new me.livelyeko.cubethmod.item.dinnerware.GlassPlate(GLASS_PLATE, new Item.Settings()));
        ...
        Registry.register(Registries.ITEM, Identifier.of(CubethMod.MOD_ID, "glass_plate_of_sliced_cake"), new me.livelyeko.cubethmod.item.dinnerware.GlassPlateOfSlicedCake(GLASS_PLATE_OF_SLICED_CAKE, new Item.Settings().maxCount(1)));
        ...
        Registry.register(Registries.ITEM, Identifier.of(CubethMod.MOD_ID, "bundt_cake"), new me.livelyeko.cubethmod.item.food.pastry.BundtCake(BUNDT_CAKE, new Item.Settings().maxCount(1)));
