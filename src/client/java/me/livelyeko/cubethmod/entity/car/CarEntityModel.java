...
public class CarEntityModel<T extends Entity> extends SinglePartEntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        structure.addChild("cube_r1", ModelPartBuilder.create()
            .uv(0, 4).cuboid(2.75F, -0.5F, 4.375F, 0.25F, 0.25F, 0.25F, new Dilation(0.0F))
            ...
            .uv(0, 0).cuboid(1.0F, -1.0F, 2.0F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
